<article class="overflow-hidden rounded-lg shadow-lg bg-white md:col-span-1 col-span-1 lg:col-span-2">
    ...
    <div class="flex items-center justify-between leading-tight p-2 md:p-4">
        <h2 class="text-md"><?php print $GLOBALS['t']['youre-mail-is'] ?>: <?php print $_SESSION['user']->EmailAddress ?></h2>
        <div class="flex gap-4">
            ...
            <a href="/user/delete" class="shadow bg-red-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"><?php print $GLOBALS['t']['delete-account'] ?></a>
        </div>
    </div>
