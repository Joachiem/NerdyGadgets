...
<div class="pb-4 text-xl font-bold">
    <h1>Algemene Voorwaarden ICTWaarborg voor consumenten</h1>
</div>
...
<div class="pb-8">
    <h1>
        ...
        Dit is overigens alleen mogelijk bij een zogenaamde koop op afstand (zie de toelichting bij artikel 10).</h1>
</div>
...
<div class="pb-8">
    ...
    <h1>Algemene voorwaarden worden vaak terecht gezien als 'moeilijke kleine lettertjes'. Daarom proberen wij in deze voorwaarden in begrijpelijke taal te spreken over zaken als prijs, levertijd, tijdstip van betaling en hetgeen precies wordt geleverd. Omdat lang niet iedereen op de hoogte is van de inhoud van de wettelijke gang van zaken die bij een koopovereenkomst geldt, beginnen we met een korte toelichting op uw wettelijke rechten als koper.</h1>
    <br>
    ...
    <br>
    <h1>De verkoper kan herstel of vervanging weigeren als de kosten hiervan in geen verhouding staan tot andere redelijke oplossingen, bijvoorbeeld vermindering van de koopprijs of teruggave van de koopsom en vergoeding van eventueel geleden schade.</h1>
</div>

<div class="pb-4 text-xl font-bold">
    <h1>Artikel 1. Alle afspraken op schrift</h1>
</div>

<div class="pb-8">
    <h1>
        Wij streven er naar onze afspraken over de prijs, eigenschappen van het te leveren product, levertijd, tijdstip van betaling e.d. zoveel mogelijk schriftelijk vast te leggen.
...
<div class="pb-4 text-xl font-bold">
    <h1>Artikel 2. Het aanbod</h1>
</div>

<div class="pb-8">
    <h1>
        1. Als voor ons aanbod (en de prijs daarvan) een beperkte geldigheidsduur geldt of hieraan voorwaarden zijn verbonden, dan wordt dit bij het aanbod vermeld.<br>
        ...
        5. Voor zover als mogelijk en indien van toepassing vermelden wij bij het aanbod voor welke hardware dan wel software de aangeboden producten/diensten (zoals software) geschikt zijn.<br>
    </h1>
</div>

<div class="pb-4 text-xl font-bold">
    <h1>Artikel 3. De prijs</h1>
</div>
...
<div class="pb-8">
    <h1>
        ...
        In dat geval kunnen wij variabele prijzen aanbieden, maar wanneer dat het geval is zullen we bij het aanbod vermelden dat het gaat om richtprijzen die gebonden zijn aan de schommelingen op de financiële markt.<br>

    </h1>
</div>

<div class="pb-4 text-xl font-bold">
    <h1>Artikel 4. Betaling</h1>
</div>
...
<div class="pb-8">
    <h1>
        ...
        Als dit wettelijk is toegestaan kunnen wij u de schade die wij daardoor lijden (renteverlies en redelijke kosten om alsnog het openstaande bedrag te innen) in rekening brengen
    </h1>
</div>

<div class="pb-4 text-xl font-bold">
    <h1>Artikel 5. Levering en uitvoering</h1>
</div>
...
<div class="pb-8">
    <h1>
        ...
        5. Het risico van beschadiging en/of vermissing van producten berust tot het moment van bezorging aan u of aan een door u aangewezen derde, bij ons, tenzij u zelf voor een aflevermethode heeft gekozen die wij niet standaard aanbieden.<br>
    </h1>
</div>
...
<div class="pb-8">
    <h1>
        ...
        Eventuele garanties, als bedoeld in artikel 6, doen geen afbreuk aan het in dit artikel bedoelde recht.
    </h1>
</div>

<div class="pb-4 text-xl font-bold">
    <h1>Artikel 8. Privacyregeling</h1>
</div>
...
<div class="pb-4 text-xl font-bold">
    <h1>Artikel 9. Eigendomsvoorbehoud</h1>
</div>

<div class="pb-8">
    <h1>
        Wij behouden de eigendom voor zolang de koop niet volledig is betaald.
        Op onze reparatieopdrachten geven wij een zo duidelijk mogelijke omschrijving van de door u voor reparatie aangeboden artikelen, zodat uw eigendomsrechten niet in het geding zijn als het reparatiebedrijf failliet gaat terwijl uw artikelen daar net op dat moment zijn.
    </h1>
</div>
...
<div class="pb-4 text-xl font-bold">
    <h1>Artikel 10b. Totstandkoming, bevestiging en beveiliging</h1>
</div>
...
<div class="pb-8">
    <h1>
        ...
        Dit kan per e-mail, sms of op een andere manier zijn. Zolang dit niet is gebeurd, kunt u nog afzien van de koop door de Overeenkomst te ontbinden. Als u via internet bestelt, zorgen wij voor beveiliging van de uitgewisselde data en voor een veilige webomgeving.
    </h1>
</div>

<div class="pb-4 text-xl font-bold">
    <h1>Artikel 10c. Bedenktijd bij levering van producten (herroepingsrecht)</h1>
</div>
...
<div class="pb-8">
    <h1>
        ...
        6. Als u heeft gekozen voor een duurdere methode van levering dan de goedkoopste standaardlevering, hoeven wij de bijkomende kosten voor de duurdere methode niet terug te betalen.<br>
    </h1>
</div>

<div class="pb-4 text-xl font-bold">
    <h1>Artikel 10d. Bedenktijd bij levering van diensten en digitale producten</h1>
</div>
