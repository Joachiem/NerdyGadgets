...
<!-- Blok 3 -->
    <div class="flex-auto shadow-lg max-w-sm rounded material-card bg-white px-2 py-2 inset-x-0 bottom-0">
        ...
        <p>
            ...
            Instagram: <a onclick="window.open(this.href); return false;" href="https://www.instagram.com/nerdygadgets.nl/">@nerdygadgets</a><br>
            YouTube: <a onclick="window.open(this.href); return false;" href="https://www.youtube.com/nerdygadgets">nerdygadgets</a><br>
