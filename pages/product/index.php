        ...
        <div class="shadow-lg max-w-sm rounded material-card bg-white">
            <div class="h-full flex flex-row justify-between">
                <div class="px-2 py-2 inset-x-0 bottom-0">
                    ...
                    <select name="sort_on_page" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white border-gray-200" onchange="this.form.submit()">
                ...
                <div class="px-2 py-2 inset-x-0 bottom-0">
                    ...
                    <select name="products_on_page" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white border-gray-200" onchange="this.form.submit()">
