    ...
    <div class="flex">
            ...
            <div class="relative mb-2">
                <div class="w-10 h-10 mx-auto bg-green-500 rounded-full text-lg text-white flex items-center">
                    <span class="grid text-white w-full">
                        <ion-icon class="place-self-center" size="small" name="person-outline"></ion-icon>
                    </span>
                </div>
            </div>
        ...
        <div class="w-1/4">
            <div class="relative mb-2">
                ...
                <div class="w-10 h-10 mx-auto bg-green-500 rounded-full text-lg text-white flex items-center">
                    <span class="grid text-white w-full">
                        <ion-icon class="place-self-center" size="small" name="home-outline"></ion-icon>
                    </span>
                </div>
            </div>
        ...
        <div class="w-1/4">
            <div class="relative mb-2">
                <div class="absolute flex align-center items-center align-middle content-center" style="width: calc(100% - 2.5rem - 1rem); top: 50%; transform: translate(-50%, -50%)">
                    <div class="w-full bg-white rounded items-center align-middle align-center flex-1">
                        <div class="w-0 bg-green-300 py-1 rounded" style="width: 50%;"></div>
                    </div>
                </div>
                ...
                <div class="w-10 h-10 mx-auto bg-white border-2 border-gray-200 rounded-full text-lg text-white flex items-center">
                    <span class="grid text-gray-700 w-full">
                        <ion-icon class="place-self-center" size="small" name="card-outline"></ion-icon>
                    </span>
                </div>
            </div>
        ...
        <div class="w-1/4">
            <div class="relative mb-2">
                ...
                <div class="w-10 h-10 mx-auto bg-white border-2 border-gray-200 rounded-full text-lg text-white flex items-center">
                    <span class="grid text-gray-700 w-full">
                        <ion-icon class="place-self-center" size="small" name="checkmark-done-outline"></ion-icon>
                    </span>
                </div>
            </div>
        ...
        <div class="leading-tight p-2 md:p-4 bg-white">
            <form class="w-full max-w-lg">
                ...
                <div class="flex md:items-center justify-between">
                    <button class="shadow bg-teal-400 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">Terug</button>
                    <button class="shadow bg-teal-400 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">Doorgaan</button>
                </div>
            </form>
        </div>
