        ...
        <div class="leading-tight flex grid grid-cols-2 gap-8 p-2 md:p-4 bg-white">
            ...
            <div>
                <form action method="POST">
                    ...
                    <input type="email" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white <?php print isset($error_messages->email) ? 'border-red-500' : 'border-gray-200' ?>" name="email" id="email" value="<?php isset($_SESSION['form']["email"]) ? print($_SESSION['form']["email"]) : '' ?>">
                    ...
                    <input type="password" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white <?php print isset($error_messages->password) ? 'border-red-500' : 'border-gray-200' ?>" name="password" id="password">
